...
export interface ApiAboutGridAboutGrid extends Struct.CollectionTypeSchema {
  collectionName: 'about_grids';
  info: {
    displayName: 'about-grid';
    pluralName: 'about-grids';
    singularName: 'about-grid';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiAboutPhotoAboutPhoto extends Struct.CollectionTypeSchema {
...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'cart.item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiImageSliderImageSlider extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image7: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    image8: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['user', 'seller', 'admin']> &
...
export interface ApiSaleSale extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    auther: Schema.Attribute.String;
    book_left: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::sale.sale'> &
      Schema.Attribute.Private;
    price_after: Schema.Attribute.Integer;
    price_before: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    rate: Schema.Attribute.Decimal;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    accountType: Schema.Attribute.Enumeration<['user', 'seller', 'admin']> &
      Schema.Attribute.DefaultTo<'user'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-grid.about-grid': ApiAboutGridAboutGrid;
